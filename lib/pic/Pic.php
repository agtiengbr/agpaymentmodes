...
class AgPaymentModesPic {
    ...
    */
    public function layer ($src = null, $options = array()) {
        ...
        if ($img['format'] == 'png') {
            require_once PATH_PIC_CLASS . 'AgPaymentModesimagecopymerge_alpha.function.php';

            AgPaymentModesimagecopymerge_alpha($this->img['source'], $img['source'], $pos['x'],
    ...
    */
    private function imagecreate($src) {
        ...
        switch ($img['format']) {
            ...
            break;
            case 'bmp':
                require_once PATH_PIC_CLASS . 'AgPaymentModesimagecreatefrombmp.function.php';
                $img['source'] = AgPaymentModesimagecreatefrombmp($src);
                $img['background'] = '#FFF';
            break;
        }
    ...
    */
    private function image($save = null, $qualite = 90) {
        ...
        switch ($this->img['format']) {
            ...
            case 'bmp':
                require_once PATH_PIC_CLASS . 'AgPaymentModesimagebmp.function.php';
                return AgPaymentModesimagebmp($this->img['source'], $save);
            break;
        }
    }
